...
(function (global, factory) {
   ...
   */
  const MonakoFace = react.forwardRef(({ size = 100, color = '#000000', eyeColor = '#ffffff', emotion = 'neutral', shape = 'circle', followCursor = true, autoAnimate = true, seed = null, className, style, onClick, }, ref) => {
