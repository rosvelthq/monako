...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MonakoReact = {}, global.jsxRuntime, global.React));
   ...
   */
  const MonakoFace = react.forwardRef(({ size = 100, color = '#000000', eyeColor = '#ffffff', emotion = 'neutral', shape = 'circle', eyeStyle = 'smooth', followCursor = true, autoAnimate = true, seed = null, className, style, onClick, }, ref) => {
      ...
      return (jsxRuntime.jsx("div", { ref: containerRef, className: className, style: { display: 'inline-block', lineHeight: 0, ...style }, onClick: onClick }));
  });
  MonakoFace.displayName = 'MonakoFace';

  exports.MonakoFace = MonakoFace;
